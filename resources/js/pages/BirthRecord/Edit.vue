...
import { 
    ...
    Calendar, Clock, Ruler, Scale, Activity, 
    MapPin, Briefcase, Droplet, Hash, CheckCircle2, Pencil
...
const form = useForm({
    baby_name: props.record.baby_name,
    birth_date: props.record.birth_date ? props.record.birth_date.split('T')[0] : '', // Handle date format if needed
    birth_time: props.record.birth_time,
    medical_record_no: props.record.medical_record_no,
    gender: props.record.gender,
    child_order: props.record.child_order,
    delivery_method: props.record.delivery_method,
    weight: props.record.weight,
    length: props.record.length,
    head_circ: props.record.head_circ,
    chest_circ: props.record.chest_circ,
    baby_blood_type: props.record.baby_blood_type || '',
    
    mother_name: props.record.mother_name,
    mother_medical_record_no: props.record.mother_medical_record_no || '',
    mother_ktp: props.record.mother_ktp || '',
    mother_address: props.record.mother_address,
    mother_occupation: props.record.mother_occupation || '',
    mother_blood_type: props.record.mother_blood_type || '',

    father_name: props.record.father_name,
    father_ktp: props.record.father_ktp || '',
    father_address: props.record.father_address || '',
    father_occupation: props.record.father_occupation || '',
    father_blood_type: props.record.father_blood_type || '',
    
    doctor_id: props.record.doctor_id,
});

const submit = () => {
    form.put(`/birth-records/${props.record.id}`);
};
...
<template>
    <Head title="Edit Data Kelahiran" />
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="max-w-7xl mx-auto p-6 md:p-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 class="text-3xl font-bold tracking-tight text-slate-900 dark:text-white bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-cyan-600">
                        Edit Data Kelahiran
                    </h1>
                    <p class="text-slate-500 dark:text-slate-400 mt-2 text-lg">
                        Perbarui informasi data kelahiran dan rekam medis.
                    </p>
                </div>
                <Link href="/birth-records">
                    <Button variant="outline" class="gap-2 border-slate-200 hover:bg-slate-50 hover:text-blue-600 transition-colors">
            ...
            <form @submit.prevent="submit" class="space-y-8">
                ...
                <!-- Section: Data Bayi -->
                <div class="space-y-4">
                    <div class="flex items-center gap-2 text-blue-600 dark:text-blue-400 font-semibold px-1">
                        <Baby class="h-5 w-5" />
                        <h2>Identitas Bayi</h2>
                        <div class="h-px bg-blue-100 dark:bg-blue-900/30 flex-1 ml-4"></div>
                    </div>

                    <Card class="border-blue-100/50 dark:border-blue-900/20 shadow-xl shadow-blue-500/5 overflow-hidden">
                            ...
                            <div class="lg:col-span-8 space-y-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative group">
                                            <Baby class="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400 group-focus-within:text-blue-500 transition-colors" />
                                            <input v-model="form.baby_name" type="text" class="w-full pl-10 pr-4 py-2.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800 focus:bg-white dark:focus:bg-slate-900 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all" placeholder="Nama lengkap bayi" required />
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative group">
                                            <Hash class="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400 group-focus-within:text-blue-500 transition-colors" />
                                            <input v-model="form.medical_record_no" type="text" class="w-full pl-10 pr-4 py-2.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800 focus:bg-white dark:focus:bg-slate-900 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-mono" placeholder="123456" required />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative group">
                                            <Calendar class="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400 group-focus-within:text-blue-500 transition-colors" />
                                            <input v-model="form.birth_date" type="date" class="w-full pl-10 pr-4 py-2.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800 focus:bg-white dark:focus:bg-slate-900 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all" required />
                                        </div>
                                    </div>
                                    <!-- Jam Lahir -->
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative group">
                                            <Clock class="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400 group-focus-within:text-blue-500 transition-colors" />
                                            <input v-model="form.birth_time" type="time" step="1" class="w-full pl-10 pr-4 py-2.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800 focus:bg-white dark:focus:bg-slate-900 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all" required />
                                        </div>
                                    </div>
                                    <!-- Jenis Kelamin -->
                                    <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input v-model="form.weight" type="number" step="0.01" class="w-full pl-9 pr-3 py-2 rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm" placeholder="3200" required />
                                        </div>
                                    </div>
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input v-model="form.length" type="number" step="0.1" class="w-full pl-9 pr-3 py-2 rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm" placeholder="48" required />
                                        </div>
                                    </div>
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input v-model="form.head_circ" type="number" step="0.1" class="w-full pl-9 pr-3 py-2 rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm" placeholder="34" required />
                                        </div>
                                    </div>
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            <Activity class="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400" />
                                            <input v-model="form.chest_circ" type="number" step="0.1" class="w-full pl-9 pr-3 py-2 rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm" placeholder="32" required />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4 pt-2 border-t border-slate-200 dark:border-slate-700">
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <select v-model="form.baby_blood_type" class="w-full pl-9 pr-3 py-2 rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm appearance-none">
                                                <option value="">-</option>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <input v-model="form.child_order" type="number" min="1" class="w-full px-3 py-2 rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm" required />
                                    </div>
                                </div>
                                
                                <div class="pt-2">
                                    <label class="text-xs font-medium text-slate-500 uppercase mb-2 block">Metode Persalinan</label>
                                    <select v-model="form.delivery_method" class="w-full px-4 py-2 rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm">
                        ...
                        <CardContent class="p-8">
                             <div class="flex flex-col md:flex-row items-center gap-8">
                                ...
                                <div class="flex-1 w-full space-y-2">
                                    ...
                                    <p class="text-xs text-slate-500 ml-1">Dokter ini yang menandatangani SKL secara digital.</p>
                                </div>
                             </div>
                        </CardContent>
                    </Card>
                ...
                <div class="sticky bottom-4 z-10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-lg border border-slate-200 dark:border-slate-700 p-4 rounded-2xl shadow-2xl flex items-center justify-between">
                    <p class="text-sm text-slate-500 hidden md:block">
                        Perubahan akan langsung terupdate pada dokumen SKL.
                    </p>
                    <div class="flex items-center gap-3 w-full md:w-auto justify-end">
                        ...
                        <Button 
                            ...
                            class="min-w-[180px] gap-2 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white shadow-lg shadow-blue-500/25 transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5"
                        >
                            <Save class="h-4 w-4" />
